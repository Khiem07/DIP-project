...
class BaseOptions():
	...
	def initialize(self):
		self.parser.add_argument('--dataroot', type=str, default="C:/Users/Admin/Documents/HUST/DIP/blurred_sharp/blu/split/train/", help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
